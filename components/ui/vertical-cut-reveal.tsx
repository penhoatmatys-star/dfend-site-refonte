...
/* Revelation par coupe : chaque caractere remonte derriere un masque.
 *
 * Source : 21st.dev, « Vertical Cut Reveal » de cnippet.dev, repris tel quel.
 * Retenu pour un detail que les autres n'ont pas : le texte complet est servi
 * en `sr-only` et les fragments animes sont `aria-hidden`, donc un lecteur
 * d'ecran lit une phrase et non une suite de lettres.
 *
 * Attention : monte au rendu serveur, `motion` ecrit l'etat initial en style
 * en ligne et le texte part hors de son masque. Sans JavaScript il ne
 * reviendrait jamais. Ne pas l'employer directement : passer par
 * `components/heading-reveal.tsx`, qui ne le monte qu'une fois la page vivante.
 */
