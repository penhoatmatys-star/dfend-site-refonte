...
/* Marquee dont la vitesse suit celle du defilement.
 *
 * Source : 21st.dev, « Scroll Velocity Text » de cnippet.dev, repris tel quel.
 * Il se met en pause hors ecran et onglet cache, et il ne s'emballe pas sous
 * `prefers-reduced-motion` : c'est ce qui l'a fait retenir plutot qu'un
 * marquee ecrit a la main.
 *
 * L'habillage vient du site : les jetons de marque sont poses a l'emploi, ce
 * fichier ne connait que `border-border`, `bg-card`, `text-foreground` et
 * consorts, qui pointent deja sur le vert, l'encre et la nuit.
 */
...
function ScrollVelocityRowImpl({
  ...
  useAnimationFrame((_, delta) => {
    ...
    // Ajout projet : sous mouvement reduit la bande ne bouge pas du tout.
    // L'original se contentait de ne pas l'accelerer.
